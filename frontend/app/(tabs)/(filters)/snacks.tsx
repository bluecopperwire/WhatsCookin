  ...
  return (
    ...
    <View className="w-full flex-1 mt-5 bg-secondary rounded-[33px]">
        <View className="flex-row px-5 mt-9">
            <View className="absolute bg-white w-[65px] h-[140px] top-[-8px] left-8 rounded-[30px] pt-[8px] pl-1">
                <Pressable onPress={() => router.push("/snacks")} className="relative bg-primary w-[50px] ml-1 h-[70px] rounded-[30px] justify-center items-center">
              <Image
                source={icons.Snacks}
            ...
            <Pressable onPress={() => router.push("/meal")} className="bg-primary w-[50px] h-[70px] ml-[85px] rounded-[30px] justify-center items-center">
              <Image
                source={icons.Meals}
                style={{ width: 40, height: 40 }}
                resizeMode="contain"
        ...
        <View className="flex-row ml-5">
            ...
            <Text className="text-white text-base ml-6 mt-auto">Drinks</Text>
          </View>
