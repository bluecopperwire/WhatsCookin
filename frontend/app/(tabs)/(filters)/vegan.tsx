  ...
  return (
    ...
    <View className="w-full flex-1 mt-5 bg-secondary rounded-[33px]">
        <View className="flex-row px-5 mt-9">
            ...
            <View className="absolute bg-white w-[65px] h-[140px] top-[-8px] left-[162px] rounded-[30px] pt-[8px] pl-2">
            <Pressable onPress={() => router.push("/vegan")} className="relative bg-primary w-[50px] h-[70px] rounded-[30px] justify-center items-center">
              <Image
                source={icons.Vegan}
                style={{ width: 40, height: 40 }}
                resizeMode="contain"
            ...
            <Pressable onPress={() => router.push("/dessert")} className="bg-primary w-[50px] h-[70px] ml-24 rounded-[30px] justify-center items-center">
              <Image
